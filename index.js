...
const product2 = products.filter((product) => product.name.startsWith("a"));
console.log(product2);
//ismi a harfi ile BİTEN ürünleri console a yazdır
const product3 = products.filter((product) => product.name.endsWith("a"));
console.log(product3);
// id si 10 olan ürünün adını console a yazdır
const product4 = products.find((product) => product.id === 10);
console.log(product4.name);
//discontinued false olan kaç ürün var
const product5 = products.filter((product) => product.discontinued === false);
console.log(product5.length);
// en pahalı ürünün adını console a yazdır
const product6 = products.find(
  (product) =>
    product.unitPrice ===
    Math.max(...products.map((product) => product.unitPrice))
);
console.log(product6);
//en ucuz ürünün adını console a yazdır
const product7 = products.find(
  (product) =>
    product.unitPrice ===
    Math.min(...products.map((product) => product.unitPrice))
);
